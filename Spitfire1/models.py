...
from Spitfire1 import db, login_manager
...
class Group(db.Model):
    ...
    groupimagefile = db.Column(db.String(20), nullable=False, default="default.jpg")
    joincode = db.Column(db.String(20), nullable=False)
